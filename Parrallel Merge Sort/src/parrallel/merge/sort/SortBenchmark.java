...
public class SortBenchmark {
    ...
    public static BenchmarkResult measureTimeAndComparisons(sortAlgorithm sorter, int[] array) {
        ...
        // Reset comparisons ADDED
        ComparisonCounter.resetComparisons();
        ...
        if (!Arrays.equals(copy, expected)) {
            throw new RuntimeException("ARRAY SORTING IS WRONG");
        }
        
        //ADDED
        long comparisons = 0;
        if (sorter instanceof MergeSort) {
            comparisons = ComparisonCounter.getComparisons();
